      ...
      <div className="container mx-auto px-6 py-32 md:py-[177px]">
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-white text-description leading-[22px] tracking-[2%] md:w-[250px]">
              Collaboration is essential for success in the adult entertainment
              industry, and at Elluxe, we believe our models thrive together.
              We provide access to a network of like-minded professionals,
              allowing models to collaborate on content, exchange tips and
              advice, and build lasting connections—even lifelong friendships.
            </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-white text-description leading-[22px] tracking-[2%] md:w-[250px]">
              ...
              advanced cybersecurity and stalker protection services to keep you
              secure. Our cybersecurity experts monitor your online presence,
              preventing identity theft, hacking, and cyber attacks.
            </p>
