    ...
    return (
      <section className="w-full bg-primary-black py-36 md:py-[181px]">
        <div className="container mx-auto px-6 flex flex-col items-center">
          <FadeInAnimation threshold={0.2} className="text-white font-semibold text-[1rem] md:text-[2.25rem] flex flex-col items-center gap-9 md:gap-16 w-full md:w-3/4 text-left md:text-center">
