...
type ApplyNowTemplateProps = ApplyNowTemplateType & {updateFields: (fields: Partial<ApplicationFormSchema>) => void}
                  ...
                  <FormItem className="text-white flex flex-row-reverse gap-6">
                    ...
                    <FormControl>
                      <Input
                        ...
                        value={field.value}
                        type="checkbox"
                        onChange={(e) => updateFields({ [fieldName]: e.target.checked })}
          ...
          <FormField
                ...
                render={({ field }) => (
                  <FormItem className="text-white">
                    ...
                    {optional && <p className="text-white text-description">*Optional</p>}
                    <FormMessage/>
                  </FormItem>
                )}
              />
